...
{
    public BaseSolidityTemplateProcessor(string templateName) : base("Moongy.RD.Launchpad.CodeGenerator.Generation.Evm.Templates", templateName, "solidity.scriban")
    {
    }
}
...
{
    return <Accordion.Root collapsible border="0" _selected={{border:"0"}} _active={{border:"0"}} _focus={{border:"0"}} {...props}>
      <Accordion.Item border="0" _selected={{border:"0"}} _active={{border:"0"}} _focus={{border:"0"}} value={(props.value? props.value[0] :"")} key={props.key}>
        <Accordion.ItemTrigger border="0" _selected={{border:"0"}} _active={{border:"0"}} _focus={{border:"0"}} bg="transparent" m={0} p={0} textAlign="left">
          <HStack>

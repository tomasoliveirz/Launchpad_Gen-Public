...
namespace Moongy.RD.Launchpad.ContractGenerator.ModelComposers.FungibleToken.Interfaces
{
    public interface IFungibleTokenComposer : ITokenComposer<FungibleTokenModel, IFungibleTokenValidator, IFungibleTokenParser>
    {
